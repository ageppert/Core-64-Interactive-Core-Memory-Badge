...
LIBS:Core64 LM v1.0-cache
EELAYER 29 0
EELAYER END
$Descr A 11000 8500
encoding utf-8
Sheet 2 2
Title "Core64 LED MATRIX (LM)"
Date "2022-06-15"
Rev "1.0"
...
Comment2 "As released 2022-06-15"
Comment3 ""
...
U 1 1 5E82F3CE
P 1600 4250
F 0 "JP1" V 1700 4300 50  0000 L CNN
F 1 "SolderJumper_3_Open" V 950 4150 50  0001 L CNN
F 2 "Jumper:SolderJumper-3_P1.3mm_Open_Pad1.0x1.5mm_NumberLabels" H 1600 4250 50  0001 C CNN
F 3 "~" H 1600 4250 50  0001 C CNN
F 4 "NO" H 1600 4250 50  0001 C CNN "INSERT?"
	1    1600 4250
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
5VUSB
Text GLabel 5700 6300 2    50   BiDi ~ 0
+BATT
Wire Wire Line
	5500 6300 5700 6300
Text Notes 6700 6500 2    50   ~ 0
POWER\nGROUND
$Comp
L power:GND #PWR?
U 1 1 604D3E08
...
F 1 "GND" H 6255 6123 50  0000 C CNN
...
F 1 "Logic_Board_Power_Enable" H 6600 6018 50  0000 C CNN
...
U 1 1 605100B9
P 1600 2150
F 0 "JP3" V 1700 2200 50  0000 L CNN
F 1 "SolderJumper_3_Open" V 950 2050 50  0001 L CNN
F 2 "Jumper:SolderJumper-3_P1.3mm_Open_Pad1.0x1.5mm_NumberLabels" H 1600 2150 50  0001 C CNN
F 3 "~" H 1600 2150 50  0001 C CNN
F 4 "NO" H 1600 2150 50  0001 C CNN "INSERT?"
	1    1600 2150
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
SILKSCREEN:\nLOGIC BOARD POWER ENABLE
Text Notes 750  7500 0    118  ~ 24
...
F 1 "GND" H 4105 6823 50  0000 C CNN
